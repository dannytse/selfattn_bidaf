...
class WordCharEmbedding(nn.Module):
    ...
    Args:
        ...
        cnn_size (int): Size of CNN out channels.
        hidden_size (int): Size of hidden activations.
    ...
    """
    def __init__(self, word_vectors, char_vectors, cnn_size, hidden_size, drop_prob):
    ...
    def forward(self, w, c, mask):
        ...
        char_emb = char_emb.view(char_emb.size(0) * char_emb.size(1), char_emb.size(3), char_emb.size(2))
...
class SelfMatchingAttention(nn.Module):
    ...
    Args:
        input_size (int): Size of input activations.
        hidden_size (int): Size of hidden activations.
        num_layers (int): Number of layers in GRU Layer.
        drop_prob (float): Probability of zero-ing out activations.
    """
    def __init__(self, input_size, hidden_size, num_layers=3, drop_prob):
